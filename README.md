...
This dashboad follows from the work in this research paper [*Understanding Deep Learning for LoS prediction via Latent Space Visualization*](final version of the paper will be uploaded here) and conveys the following information:
